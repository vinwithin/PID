@extends('layout.app')
@section('title', 'Publikasi Dokumentasi Teknis')
@section('description', 'Dokumen Teknis')
@section('content')
    <div class="w-100">
        <div class="card">
            ...
            <div class="card-body">
                <form id="editorForm" method="POST" action="/dokumen-teknis/update/{{$data->id}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <a href="/dokumen-teknis" class="btn btn-warning">Kembali</a>
