<footer class="bg-dark p-4" style="bottom: 0">
    <div class="container d-flex justify-content-between">
        <div class="row g-4">
            ...
            <div class="col ">
                <h3 class="fw-bold border-bottom text-white">Link Utama</h3>
            ...
            <div class="col">
                <h3 class="fw-bold border-bottom text-white">Kontak Kami</h3>
                ...
                <div class="d-flex flex-row align-items-center mt-2">
                    <p class="text-white mb-0 me-4">Email</p>
